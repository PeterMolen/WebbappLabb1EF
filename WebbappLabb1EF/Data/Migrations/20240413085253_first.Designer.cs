...
namespace WebbappLabb1EF.Data.Migrations
{
    ...
    [Migration("20240413085253_first")]
    partial class first
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebbappLabb1EF.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("WebbappLabb1EF.Models.Leave", b =>
                {
            ...
            modelBuilder.Entity("WebbappLabb1EF.Models.LeaveRequest", b =>
                {
            ...
            modelBuilder.Entity("WebbappLabb1EF.Models.LeaveRequest", b =>
                {
                    b.HasOne("WebbappLabb1EF.Models.Employee", "Employee")
                        .WithMany("LeaveRequest")
                        .HasForeignKey("FkEmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebbappLabb1EF.Models.Leave", "Leave")
                        .WithMany("LeaveRequest")
