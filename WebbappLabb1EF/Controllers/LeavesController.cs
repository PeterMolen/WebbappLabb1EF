...
namespace WebbappLabb1EF.Controllers
{
    ...
    public class LeavesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LeaveId,TypeOfLeave")] Leave leave)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaveId,TypeOfLeave")] Leave leave)
        {
            if (id != leave.LeaveId)
            {
                return NotFound();
